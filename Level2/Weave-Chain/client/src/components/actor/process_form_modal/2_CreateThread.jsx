...
const CreateThread = ({ isOpen, onClose, assetId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (priceEth) {
            ...
            try {
                const result = await supplyChain.methods.createThread(assetId, weiPrice).send({ from: accounts[0] });
                console.log(result);
                if (result && assetId) {
                    setSuccessMsg(
                        <span>
                    ...
                    <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        >
                            <form onSubmit={handleSubmit} className="max-w-md">
                                <h2 className="text-2xl text-center font-bold mb-8">Create Thread</h2>
                                <div className="mb-1">
