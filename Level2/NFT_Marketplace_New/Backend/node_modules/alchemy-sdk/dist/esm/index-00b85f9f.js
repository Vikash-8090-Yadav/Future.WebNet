    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield import('./alchemy-provider-49464307.js');
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield import('./alchemy-websocket-provider-fdb0db0c.js');
...
class NotifyNamespace {
    ...
    createWebhook(url, type, params) {
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            const data = Object.assign(Object.assign(Object.assign({ network, webhook_type: type, webhook_url: url }, (appId && { app_id: appId })), nftFilterObj), (addresses && { addresses }));
...
//# sourceMappingURL=index-00b85f9f.js.map
