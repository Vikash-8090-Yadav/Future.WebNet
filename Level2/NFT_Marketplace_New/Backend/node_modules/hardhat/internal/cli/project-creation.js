...
async function writeEmptyHardhatConfig() {
    return fs_extra_1.default.writeFile("hardhat.config.js", exports.EMPTY_HARDHAT_CONFIG, "utf-8");
}
...
function showSoliditySurveyMessage() {
    ...
    console.log();
    console.log(chalk_1.default.cyan("Please take a moment to complete the 2022 Solidity Survey: https://hardhat.org/solidity-survey-2022"));
}
