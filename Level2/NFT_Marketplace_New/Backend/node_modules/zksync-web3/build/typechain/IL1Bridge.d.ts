...
interface IL1BridgeInterface extends ethers.utils.Interface {
  functions: {
    "claimFailedDeposit(address,address,bytes32,uint256,uint256,bytes32[])": FunctionFragment;
    "deposit(address,address,uint256)": FunctionFragment;
    "finalizeWithdrawal(uint256,uint256,bytes,bytes32[])": FunctionFragment;
...
export class IL1Bridge extends Contract {
  ...
  functions: {
    ...
    "claimFailedDeposit(address,address,bytes32,uint256,uint256,bytes32[])"(
      _depositSender: string,
      _l1Token: string,
      _l2TxHash: BytesLike,
      _l2BlockNumber: BigNumberish,
    ...
    "finalizeWithdrawal(uint256,uint256,bytes,bytes32[])"(
      _l2BlockNumber: BigNumberish,
      _l2MessageIndex: BigNumberish,
      _message: BytesLike,
      _merkleProof: BytesLike[],
