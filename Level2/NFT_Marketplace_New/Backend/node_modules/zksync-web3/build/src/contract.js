...
class ContractFactory extends ethers_1.ethers.ContractFactory {
    ...
    getDeployTransaction(...args) {
        ...
        (_c = (_e = txRequest.customData).factoryDeps) !== null && _c !== void 0 ? _c : (_e.factoryDeps = []);
        (_d = (_f = txRequest.customData).ergsPerPubdata) !== null && _d !== void 0 ? _d : (_f.ergsPerPubdata = utils_1.DEFAULT_ERGS_PER_PUBDATA_LIMIT);
