...
export function AdapterL1<TBase extends Constructor<TxSender>>(Base: TBase) {
    return class Adapter extends Base {
        ...
        async finalizeWithdrawal(withdrawalHash: BytesLike, index: number = 0) {
            ...
            return await l1Bridge.finalizeWithdrawal(log.blockNumber, proof.id, message, proof.proof);
        }
        ...
        async isWithdrawalFinalized(withdrawalHash: BytesLike, index: number = 0) {
            ...
            return await l1Bridge.isWithdrawalFinalized(log.blockNumber, proof.id);
        }
