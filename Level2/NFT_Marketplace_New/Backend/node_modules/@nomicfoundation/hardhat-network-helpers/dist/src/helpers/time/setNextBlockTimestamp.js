...
async function setNextBlockTimestamp(timestamp) {
    ...
    const latestTimestampRpc = (0, utils_1.toRpcQuantity)(await (0, latest_1.latest)());
    (0, utils_1.assertLargerThan)(BigInt(timestampRpc), BigInt(latestTimestampRpc), "timestamp");
