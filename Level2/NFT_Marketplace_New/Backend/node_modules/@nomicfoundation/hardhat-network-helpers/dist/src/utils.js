...
exports.toPaddedRpcQuantity = exports.assertLargerThan = exports.assertPositiveNumber = exports.assertTxHash = exports.assertHexString = exports.assertValidAddress = exports.toRpcQuantity = exports.toBigInt = exports.getHardhatProvider = void 0;
...
function assertPositiveNumber(n) {
    if (n <= BigInt(0)) {
        throw new errors_1.HardhatNetworkHelpersError(`Invalid input: expected a positive number but ${n} was given.`);
    }
}
