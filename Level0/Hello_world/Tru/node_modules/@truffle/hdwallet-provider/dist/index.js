...
class HDWalletProvider {
    ...
    checkBIP39Mnemonic({ addressIndex, numberOfAddresses, phrase, password }) {
        if (!bip39_1.validateMnemonic(phrase, english_1.wordlist)) {
            throw new Error("Mnemonic invalid or undefined");
        }
        this.hdwallet = ethereumjs_wallet_2.hdkey.fromMasterSeed(Buffer.from(bip39_1.mnemonicToSeedSync(phrase, password)));
