...
module.exports = {
  ...
  networks: {
    ...
    matic:{
      provider :()=> new HDWalletProvider('mansion strategy carry code lawsuit absurd sustain kitchen guitar lock grass nurse', 'https://polygon-mumbai.infura.io/v3/95688893704a4d5bac083296c3547383'),
      network_id :80001,
      confirmations : 2,
      timeoutBlocks :2000,
      skipDryRun : true,
