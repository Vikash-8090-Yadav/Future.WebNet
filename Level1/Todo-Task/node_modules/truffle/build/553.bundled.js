...
const axios_1 = __importDefault(__webpack_require__(540606));
const dashboard_message_bus_common_1 = __webpack_require__(175756);
const debug_1 = __importDefault(__webpack_require__(615158));
...
function waitForOutstandingPromises(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const iterable = (target
            ? (_a = _outstandingPromiseInstanceMap.get(target)) === null || _a === void 0 ? void 0 : _a.values() : _outstandingPromiseMap.keys()) || [];
