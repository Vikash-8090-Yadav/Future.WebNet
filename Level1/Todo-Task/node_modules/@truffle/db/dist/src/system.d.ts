...
export declare const schema: import("graphql").GraphQLSchema, attach: <N extends "memory" | "sqlite" | "couch">(options?: Meta.Pouch.Adapters.AttachOptions<N> | undefined) => Meta.Workspace<Collections>, resources: Meta.Process.ResourceProcessors<Collections>, forDb: (db: Meta.Db<Collections>) => {
