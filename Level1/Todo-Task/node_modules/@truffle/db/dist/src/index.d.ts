...
export { Network };
export { DataModel, Db } from "./resources/index";
 ...
 */
export declare const connect: (options?: _System.ConnectOptions | undefined) => Resources.Db;
/**
 ...
 */
export declare const serve: (options?: _System.ConnectOptions | undefined) => import("apollo-server").ApolloServer;
/**
 ...
 */
export declare const generateId: _System.GenerateId;
/**
...
export declare namespace Graph {
    const schema: import("graphql").GraphQLSchema;
}
/**
 * @category Internal
 */
export declare namespace Pouch {
    const attach: <N extends "memory" | "sqlite" | "couch">(options?: Meta.Pouch.Adapters.AttachOptions<N> | undefined) => Meta.Workspace<Resources.Collections>;
}
