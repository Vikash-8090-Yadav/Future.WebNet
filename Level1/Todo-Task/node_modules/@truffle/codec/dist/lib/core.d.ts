 ...
 * @Category Decoding
 */
export declare function decodeEvent(info: Evm.EvmInfo, address: string | null, //if null is passed, must pass currentContext in info
options?: LogOptions): Generator<DecoderRequest, LogDecoding[], Uint8Array>;
/**
