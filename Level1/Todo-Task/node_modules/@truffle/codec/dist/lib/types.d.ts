 ...
 * @Category Requests
 */
export declare type WrapRequest = IntegerWrapRequest | DecimalWrapRequest | AddressWrapRequest;
/**
 ...
 * @Category Requests
 */
export declare type WrapResponse = IntegerWrapResponse | DecimalWrapResponse | AddressWrapResponse;
/**
 ...
 * @category Inputs
 */
export declare type BlockSpecifier = number | "genesis" | "latest" | "pending";
/**
 * @hidden
 */
export declare type RegularizedBlockSpecifier = number | "pending";
/**
