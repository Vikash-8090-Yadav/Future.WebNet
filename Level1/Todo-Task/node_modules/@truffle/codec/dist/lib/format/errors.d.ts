...
import type { PaddingType } from "../common";
/**
 * A result which is an error rather than a value
 *
 * @Category General categories
 */
export declare type ErrorResult = ElementaryErrorResult | ArrayErrorResult | MappingErrorResult | StructErrorResult | MagicErrorResult | TypeErrorResult | TupleErrorResult | FunctionExternalErrorResult | FunctionInternalErrorResult | OptionsErrorResult;
/**
 * An error result for an ABI type
 *
 * @Category General categories
 */
export declare type AbiErrorResult = UintErrorResult | IntErrorResult | BoolErrorResult | BytesErrorResult | AddressErrorResult | FixedErrorResult | UfixedErrorResult | StringErrorResult | ArrayErrorResult | FunctionExternalErrorResult | TupleErrorResult;
/**
 * One of the underlying errors contained in an [[ErrorResult]]
 *
 * @Category General categories
 */
export declare type DecoderError = GenericError | UintError | IntError | BoolError | BytesStaticError | BytesDynamicError | AddressError | StringError | FixedError | UfixedError | ArrayError | MappingError | StructError | MagicError | TypeErrorUnion | TupleError | EnumError | UserDefinedValueTypeError | ContractError | FunctionExternalError | FunctionInternalError | InternalUseError;
/**
 * An error result for an elementary value
 *
 * @Category Elementary types
 */
export declare type ElementaryErrorResult = UintErrorResult | IntErrorResult | BoolErrorResult | BytesErrorResult | AddressErrorResult | StringErrorResult | FixedErrorResult | UfixedErrorResult | EnumErrorResult | UserDefinedValueTypeErrorResult | ContractErrorResult;
/**
 * An error result for a built-in value type
 *
 * @Category Elementary types
 */
export declare type BuiltInValueErrorResult = UintErrorResult | IntErrorResult | BoolErrorResult | BytesStaticErrorResult | AddressErrorResult | FixedErrorResult | UfixedErrorResult;
/**
 * An error result for a bytestring
 *
 * @Category Elementary types
 */
export declare type BytesErrorResult = BytesStaticErrorResult | BytesDynamicErrorResult;
/**
 ...
 * @Category Elementary types
 */
export declare type UintError = UintPaddingError;
/**
 ...
 * @Category Elementary types
 */
export declare type IntError = IntPaddingError;
/**
 ...
 * @Category Elementary types
 */
export declare type BoolError = BoolOutOfRangeError | BoolPaddingError;
/**
 ...
 * @Category Elementary types
 */
export declare type BytesStaticError = BytesPaddingError;
/**
 ...
 * @Category Elementary types
 */
export declare type BytesDynamicError = DynamicDataImplementationError;
/**
 ...
 * @Category Elementary types
 */
export declare type AddressError = AddressPaddingError;
/**
 ...
 * @Category Elementary types
 */
export declare type StringError = DynamicDataImplementationError;
/**
 ...
 * @Category Elementary types
 */
export declare type FixedError = FixedPaddingError;
/**
 ...
 * @Category Elementary types
 */
export declare type UfixedError = UfixedPaddingError;
/**
 ...
 * @Category User-defined elementary types
 */
export declare type EnumError = EnumOutOfRangeError | EnumPaddingError | EnumNotFoundDecodingError;
/**
 ...
 * @Category User-defined elementary types
 */
export declare type UserDefinedValueTypeError = WrappedError;
/**
 ...
 * @Category User-defined elementary types
 */
export declare type ContractError = ContractPaddingError;
/**
 ...
 * @Category Container types
 */
export declare type ArrayError = DynamicDataImplementationError;
/**
 ...
 * @Category Container types
 */
export declare type MappingError = never;
/**
 ...
 * @Category Container types
 */
export declare type StructError = DynamicDataImplementationError;
/**
 ...
 * @Category Container types
 */
export declare type TupleError = DynamicDataImplementationError;
/**
 ...
 * @Category Special container types (debugger-only)
 */
export declare type MagicError = never;
/**
 ...
 * @Category Special container types (debugger-only)
 */
export declare type TypeErrorUnion = never;
/**
 ...
 * @Category Function types
 */
export declare type FunctionExternalError = FunctionExternalNonStackPaddingError | FunctionExternalStackPaddingError;
/**
 ...
 * @Category Function types
 */
export declare type FunctionInternalError = FunctionInternalPaddingError | NoSuchInternalFunctionError | DeployedFunctionInConstructorError | MalformedInternalFunctionError;
/**
 ...
 */
export declare type OptionsError = never;
/**
 * A type-non-specific error
 *
 * @Category Generic errors
 */
export declare type GenericError = UserDefinedTypeNotFoundError | IndexedReferenceTypeError | ReadError;
/**
 * A read error
 *
 * @Category Generic errors
 */
export declare type ReadError = UnsupportedConstantError | ReadErrorStack | ReadErrorBytes | ReadErrorStorage | StorageNotSuppliedError | UnusedImmutableError | CodeNotSuppliedError;
/**
 * An error resulting from overlarge length or pointer values
 *
 * @Category Generic errors
 */
export declare type DynamicDataImplementationError = OverlongArraysAndStringsNotImplementedError | OverlargePointersNotImplementedError;
/**
 ...
 * @Category Generic errors
 */
export declare type ErrorForThrowing = UserDefinedTypeNotFoundError | ReadError;
/**
 ...
 */
export declare type BytesLocation = "memory" | "calldata" | "eventdata" | "returndata" | "code";
/**
 ...
 */
export declare type InternalUseError = OverlongArrayOrStringStrictModeError | InternalFunctionInABIError;
/**
