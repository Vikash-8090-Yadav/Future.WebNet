 ...
 */
export declare type Result = ElementaryResult | ArrayResult | MappingResult | StructResult | TupleResult | MagicResult | TypeResult | FunctionExternalResult | FunctionInternalResult | OptionsResult;
/**
 * An actual value, not an error (although if a container type it may contain errors!)
 *
 * @Category General categories
 */
export declare type Value = ElementaryValue | ArrayValue | MappingValue | StructValue | TupleValue | MagicValue | TypeValue | FunctionExternalValue | FunctionInternalValue | OptionsValue;
/**
 ...
 */
export declare type OptionsResult = OptionsValue | Errors.OptionsErrorResult;
/**
 * An options value
 *
 * @Category Special types (encoder-only)
