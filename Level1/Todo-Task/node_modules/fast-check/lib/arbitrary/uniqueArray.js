...
function uniqueArray(arb, constraints = {}) {
    ...
    const arrayArb = (0, Converters_1.convertFromNext)(new ArrayArbitrary_1.ArrayArbitrary(nextArb, minLength, maxGeneratedLength, maxLength, depthIdentifier, setBuilder));
    if (minLength === 0)
        return arrayArb;
