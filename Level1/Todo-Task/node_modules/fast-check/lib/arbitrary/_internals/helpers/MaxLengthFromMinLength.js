...
exports.resolveSize = exports.depthFactorFromSizeForArbitrary = exports.maxGeneratedLengthFromSizeForArbitrary = exports.relativeSizeToSize = exports.maxLengthFromMinLength = exports.DefaultSize = exports.MaxLengthUpperBound = void 0;
...
function maxGeneratedLengthFromSizeForArbitrary(size, minLength, maxLength, specifiedMaxLength) {
    const { baseSize: defaultSize = exports.DefaultSize, defaultSizeToMaxWhenMaxSpecified = true } = (0, GlobalParameters_1.readConfigureGlobal)() || {};
...
function depthFactorFromSizeForArbitrary(depthFactorOrSize) {
    if (typeof depthFactorOrSize === 'number') {
        return depthFactorOrSize;
    }
    const { baseSize } = (0, GlobalParameters_1.readConfigureGlobal)() || {};
    if (depthFactorOrSize === undefined && baseSize === undefined) {
        return 0;
    }
    const defaultSize = baseSize !== undefined ? baseSize : exports.DefaultSize;
...
exports.depthFactorFromSizeForArbitrary = depthFactorFromSizeForArbitrary;
