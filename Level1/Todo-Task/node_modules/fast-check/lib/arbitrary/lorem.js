...
function lorem(...args) {
    ...
    if (sentencesMode) {
        const sentence = (0, Converters_1.convertToNext)((0, array_1.array)(wordArbitrary, { minLength: 1, size: 'small' })).map(WordsToLorem_1.wordsToSentenceMapper, (0, WordsToLorem_1.wordsToSentenceUnmapperFor)(wordArbitraryNext));
        return (0, Converters_1.convertFromNext)((0, Converters_1.convertToNext)((0, array_1.array)((0, Converters_1.convertFromNext)(sentence), { minLength: 1, maxLength: maxCount, size })).map(WordsToLorem_1.sentencesToParagraphMapper, WordsToLorem_1.sentencesToParagraphUnmapper));
    }
    else {
        return (0, Converters_1.convertFromNext)((0, Converters_1.convertToNext)((0, array_1.array)(wordArbitrary, { minLength: 1, maxLength: maxCount, size })).map(WordsToLorem_1.wordsToJoinedStringMapper, (0, WordsToLorem_1.wordsToJoinedStringUnmapperFor)(wordArbitraryNext)));
    }
}
exports.lorem = lorem;
