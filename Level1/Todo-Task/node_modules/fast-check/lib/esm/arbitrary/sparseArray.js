...
export function sparseArray(arb, constraints = {}) {
    ...
    const sparseArrayNoTrailingHole = convertFromNext(convertToNext(uniqueArray(tuple(restrictedIntegerArbitraryBuilder(0, maxGeneratedIndexAuthorized, maxIndexAuthorized), arb), {
